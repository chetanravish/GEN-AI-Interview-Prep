  ...
  return (
    <div className="relative min-h-[calc(100vh-72px)] flex items-center justify-center bg-slate-950 px-6 py-16 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-0 top-0 h-80 w-80 rounded-full bg-indigo-600/20 blur-3xl" />
        <div className="absolute right-0 bottom-0 h-96 w-96 rounded-full bg-cyan-500/15 blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
        ...
        <p className="mt-3 text-slate-400 leading-relaxed">
          Join ResumeAI and start building professional ATS-friendly resumes with
          AI assistance.
        </p>
          ...
          <Field label="Username">
            <div className="relative">
              ...
              <input
                ...
                placeholder="chetan_ravish"
                className="w-full rounded-xl border border-slate-700 bg-slate-900/70 py-3 pl-10 pr-4 text-white placeholder:text-slate-500 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20"
              />
            </div>
          </Field>
